...
{
    public class Female_GC_Text_To_Speech : MonoBehaviour
    {
        public static GCTextToSpeech _gcTextToSpeech;
        public UnityEvent SynthesizeEvents;
        ...
        private void FillVoicesList()
        {
            ...
            //{
            if (_voices[11].name.ToLower().Contains(((Enumerators.VoiceType)voiceTypesDropdown.value).ToString().ToLower()))
                elements.Add(_voices[11].name);
            //}
