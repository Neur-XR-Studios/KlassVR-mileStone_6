...
namespace XR.Interaction.Editor
{
    ...
    public static class PackageCleanup
    {
        ...
        public const string DEPRECATED_TAG = "xr_interaction_deprecated";
        public const string MOVED_TAG = "xr_interaction_moved_";
        private const string MENU_NAME = "XR/Interaction/Clean Up Package";
        private const string AUTO_CLEANUP_KEY = "XR_Interaction_AutoCleanUp_" + PACKAGE_VERSION;
