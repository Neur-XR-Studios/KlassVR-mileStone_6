...
namespace XR.Interaction.Samples
{
    public class PoseUseSample : MonoBehaviour
    {
        ...
        {
            var centerEyePos = FindObjectOfType<XRCameraRig>().centerEyeAnchor.position;
            Vector3 spawnSpot = centerEyePos + FindObjectOfType<XRCameraRig>().centerEyeAnchor.forward;
